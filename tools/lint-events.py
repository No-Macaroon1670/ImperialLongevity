...
for i, line in enumerate(body.splitlines(), 1):
    ...
    NO_W_OK = {'洞天清录', '李纲锏', '中山长城', '燕长城', '秦昭王长城', '北齐长城', '隋长城', '淳化元宝金钱', '绿松石龙形器', '三道岗沉船', '簪花', '金鱼村窖藏', '象纹铜铙', '法书要录', '金马小像', '琅琊刻石', '乃孙作祖己鼎', '青釉堆塑谷仓罐', '乾隆石经',
    # 海外批五条（2026-09-01，判官裁 w 留空族：馆藏单件 zh/en 维基皆无专条或 w 判留空）
    '弥勒佛鎏金铜像', '赵见憘造像碑', '328窟供养菩萨像', '耀州窑睡童枕', '玫茵堂鸡缸杯',
    '马蹄金',
    # 条条商路首波八条（2026-09-08，库主裁「无 w 走 NO_W_OK＋m」：海外出土点 zh 维基无条，m 挂研究／馆方页）
    '巴泽雷克战国绣', '考山考汉陶', '尚加长沙窑片', '红海元青花沉船', '卡塞尔青瓷碗', '沃海马尔中国瓷', '圣阿古斯丁号', '中国瓷到新墨西哥'}  # 甲批 2026-09-01：真身标题被同名植物占位、金币义无条，wsrc 挂漢書/卷006  # 无维基条判例：维基锚是服务不是门槛（象纹铜铙 2026-08-26 入：六候选REST实测皆missing，卡即百科自足；琅琊刻石 2026-08-26 入：琅琊刻石/琅邪刻石/瑯琊刻石/琅琊台刻石/瑯琊臺刻石五种写法 REST 实测皆 404，原文走维基文库《瑯邪臺刻石》；青釉堆塑谷仓罐 2026-08-26 入：正名 REST 404，类目条魂瓶虽200但系一类非一件、库内无个体挂类目先例，照金马小像判例不挂）
