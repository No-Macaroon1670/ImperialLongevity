...
for i, line in enumerate(body.splitlines(), 1):
    ...
    NO_W_OK = {'绿松石龙形器', '三道岗沉船', '簪花', '金鱼村窖藏', '象纹铜铙', '法书要录', '金马小像', '琅琊刻石', '乃孙作祖己鼎', '青釉堆塑谷仓罐'}  # 无维基条判例：维基锚是服务不是门槛（象纹铜铙 2026-08-26 入：六候选REST实测皆missing，卡即百科自足；琅琊刻石 2026-08-26 入：琅琊刻石/琅邪刻石/瑯琊刻石/琅琊台刻石/瑯琊臺刻石五种写法 REST 实测皆 404，原文走维基文库《瑯邪臺刻石》；青釉堆塑谷仓罐 2026-08-26 入：正名 REST 404，类目条魂瓶虽200但系一类非一件、库内无个体挂类目先例，照金马小像判例不挂）
