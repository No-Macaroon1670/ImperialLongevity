...
HEAD = {'晋': '晋国（前780–前349）', '姜齐': '姜齐（约前794–前379）',
        ...
        '韩': '韩国（前453–前230）', '赵': '赵国（前475–前228）', '魏': '魏国（前453–前225）'}
...
warn = []
total = 0
for state in ['晋', '姜齐', '田齐', '楚', '秦', '燕', '吴', '越', '韩', '赵', '魏']:
