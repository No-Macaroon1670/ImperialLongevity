...
for fn in ["dis_conv.json", "dis2_conv.json", "prehan_conv.json", "dis3_conv.json", "qinhan_conv.json", "song_conv.json", "weijin_conv.json", "tang_conv.json", "mingqing_conv.json"]:
