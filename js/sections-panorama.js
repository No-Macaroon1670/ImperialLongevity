...
export const SECTIONS = [
  {
    ...
    controls: [
      ...
      // 「视图」二字不出现在版面上（库主 2026-09-08 追加 §六.4）：两颗药丸的
      // 字面自己已经说清了这是在选什么，标签只留给读屏（labelHidden 走视觉隐藏
      // 而非 display:none）。≤720px 药丸缩成「竖」「横」，触摸区反而加大——
      // 指头点的是那块地方，不是那个字；aria-label 仍报全名
      seg('panoramaMode', '视图', [['river', '竖向河流'], ['lanes', '横向泳道']], undefined, {
        labelHidden: true,
        short: { river: '竖', lanes: '横' },
      }),
