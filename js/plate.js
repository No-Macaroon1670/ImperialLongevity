...
export const RIVER_TAGS = [['黄河', 37.4, 110.5], ['长江', 30.2, 108.6], ['淮河', 32.55, 115.8]];
/** 湖名（2026-08-26 库主令：凡地理要素皆有名）。位置取各湖 NE 多边形 bbox 中腹，
 *  面状名与山名同律不许跑远；字比河名小一号——湖是水系的结，不是干线。 */
export const LAKE_TAGS = [['洞庭湖', 28.9, 112.4], ['鄱阳湖', 29.2, 116.3], ['太湖', 31.2, 120.25], ['青海湖', 36.9, 100.2]];

// 元素工厂的正本迁至 js/dom.js（与 charts.js 同吃一份，两系本就逐字等价：
// 差的只有那个第三参 children，而 plate 系 91 处调用无一传它）
export { el };
