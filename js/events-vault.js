...
export const EVENTS_VAULT = [
  ...
  // 搬回前须办两事：① ✅已办（2026-08-25 库主人工过目）：百度立条名「灵井许昌人遗址」
  //   （item/4773344，不带引号）——与 w 的带引号写法异形，故写 b:'灵井许昌人遗址'；
  //   ② 中文一手复核现藏机构及此后有无移交／巡展（仍欠）。
