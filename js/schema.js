...
/** 称号类别：用于「入库标准」的透明化。公/侯/子为先秦诸侯（春秋战国的国君多数终身未称王，
 *  楚君称王前为子爵之「敖」）；卿为三家分晋后、受命为侯前的晋卿（赵襄子、韩康子、魏桓子一辈）。 */
export const TITLE_CLASS = { 帝: '皇帝', 天王: '天王', 汗: '大汗', 王: '国王/藩王', 公: '诸侯（公）', 侯: '诸侯（侯）', 子: '诸侯（子）', 卿: '晋卿（三家前段）', 伯: '诸侯（伯）' };   // 伯：西伯昌、共伯和——伯爵之国的单主客串
